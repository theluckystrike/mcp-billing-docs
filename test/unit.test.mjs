...
test.skip("PDFs are Pro and carry the document title and the invoice number", async (t) => {
...
test.skip("billing_docs_report answers credited totals per currency and the open orders", async (t) => {
  const { box, c } = open(t, { key: proKey() });
  seedInvoice(box.dataHome, simpleInvoice("INV-2026-0001"));
  await c.init();
