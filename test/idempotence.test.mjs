...
test.skip("credit_note_create refuses a byte-identical record and names the credit note already there", async (t) => {
...
test.skip("purchase_order_create refuses a byte-identical record and names the order already there", async (t) => {
  const { box, c } = open(t, { key: proKey() });
  await c.init();
  const args = {
